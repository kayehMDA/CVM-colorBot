...
class AimTracker:
    ...
    def __init__(self, app, target_fps=80):
        ...
        self.humanized_aim_enabled = bool(getattr(config, "humanized_aim_enabled", False))
        ...
        self.humanized_aim_enabled_sec = bool(getattr(config, "humanized_aim_enabled_sec", False))
